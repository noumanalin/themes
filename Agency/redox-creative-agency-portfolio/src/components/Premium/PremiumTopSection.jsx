...
const PremiumTopSection = () => {
  ...
  return (
    <article className="max-w-4xl mx-auto text-center">
      ...
      >
        Utilize the comprehensive suite of specialized tools designed to help you
        attract more <br />
        visitors, potential customers, and successful outcomes. You won&apos;t require numerous plugins any longer.
      </motion.p>
    </article>
  )
}
