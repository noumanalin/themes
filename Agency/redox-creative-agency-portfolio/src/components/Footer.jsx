...
const data = [
  {text: <p>Premium <br /> Creator</p>, icon: icon1},
  {text: <p>Highlighted <br /> Selection</p>, icon: icon2},
  {text: <p>Leading <br /> Products</p>, icon: icon3},
  {text: <p>Weekly Top <br /> Performer</p>, icon: icon4},
]
          ...
          <div className="flex flex-wrap">
            ...
            >
              <Link to={'/'} className='flex items-center gap-2 relative z-10'>
                Get Template <ArrowRight size={20} />
              </Link>
            </MyButton>
              <span className="absolute z-50 md:-top-6 right-4 rounded-full bg-[#98f027] text-zinc-800   md:text-3xl font-medium px-2  md:px-4 md:p-3 text-center">
                  Only <br /> <span className="text-zinc-950"><strong>$19</strong></span>
              </span>
            </div>
