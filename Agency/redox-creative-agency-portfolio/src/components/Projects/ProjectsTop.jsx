...
const ProjectsTop = () => {
  const words = ["Begin", "your", "journey"];
  const normalText = "using ready-made ";
  const specialText = "templates."; // this will use Moon Dance font
  ...
  return (
    <article className="text-center ">
      ...
      >
        ...
        {/* Special word "templates." with Moon Dance font */}
      ...
      >
        Discover an impressive assortment of pre-designed layouts.
        <br className="hidden sm:block" />
        Every template is completely adaptable—combine various sections to
        craft your distinctive design effortlessly.
      </motion.p>
